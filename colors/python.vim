...
if exists("python_highlight_space_errors") && python_highlight_space_errors != 0
  syn matcythonSpaceError	"\s\+$" display
endif
...
if exists("python_highlight_exceptions") && python_highlight_exceptions != 0
  ...
  syn keywod pythonExClass	LookupError EnvironmentError

  syn keyword pyrror AttributeError BufferError EOFError
  syn keyword pythonEeneratorExit IOError
  syn keyword pythonExClass	ImportError InxClass	KeyboardInterrupt MemoryError NameError
  syn keyword pySError OverflowError
  syn keyword pythonExClass	ReferenceError syn keyword pythonExClass	SyntaxError IndentationError TabErrostemExit TypeError
  syn keyword pythonExClass	UnboundLocalErro pythonExClass	UnicodeEncodeError UnicodeDecodeError
  syn keywlueError VMSError
  syn keyword pythonExClass	WindowsError Zerorning BytesWarning DeprecationWarning
  syn keyword pythonExClaSyntaxWarning
  syn keyword pythonExClass	RuntimeWarning FutureImportWarning UnicodeWarning
endif

if exists("python_slow_syncn sync minlines=2000")
else
